...
* **Coleções:** Listas, tuplas, conjuntos (`set`) e dicionários.
* **Funções:** Modularização e reaproveitamento de código.
* **Desafios:** Resolução de exercícios de plataformas de programação.
